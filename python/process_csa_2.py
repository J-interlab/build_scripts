...
import utils
import zip_utils
FOLDER_PATH = "public\\car_csa"
# asset_scenes_json = 45032171

# __pc__.js
SCRIPTS = [ 99664696, 102307691, 102307765, 102307769, 102307770, 102309930, 102309931, 102309937, 102309938, 102310003, 102310666, 102310731, 102310754, 102310755, 102310787, 102313172]

...
import utils
import zip_utils
FOLDER_PATH = "public\\car_HMD"
# asset_scenes_json = 45032171

# __pc__.js
SCRIPTS = [ 159026913, 159026901, 159026910, 159026897, 159026918, 159026908, 159026902, 161027936, 167417922, 167417923, 167417924, 167419519, 167485039, 167491274, 167491132, 167437171, 167431525, 167491330, 167491335, 167526213, 167528832, 167549779, 167614258 ]
...
for car_index in [11]:
    ...
    for obj in pc_obj['scenes']:
        if obj['name'] == 'start' or obj['name'].startswith(f'interior{car_index}_') or obj['name'] == 'VR Scene':

...
import utils
import zip_utils
FOLDER_PATH = "public\\car_apc"
# asset_scenes_json = 45032171

# __pc__.js

# APAC
SCRIPTS = [ 151038529, 151333184, 151383896, 151391001, 151333161, 151383910, 151383898, 151333160, 151038531, 151334200, 151334201, 151334191, 151334192, 151383908, 151334198, 151333186, 151337814, 151389963, 158062735, 158062778, 158074735, 161012203 ]
# EU demo 2
# SCRIPTS = [ 156795639, 156797159, 156797166, 156807630, 156807632, 156853155, 158324345, 158325370, 158325561 ]
